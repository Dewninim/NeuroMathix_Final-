...
class NotificationBell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (FirebaseAuth.instance.currentUser == null) {
      return _bell(context, count, const []);
    }
        ...
        title: Row(
          children: [
            ...
            if (notifications.any((item) => !item.isRead))
              TextButton(
                onPressed: () async {
                  await service.markAllRead(notifications);
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      leading: Icon(
                        item.type.contains('review')
                            ? Icons.calendar_month_rounded
                            : item.type.contains('teacher')
                      ...
                      onTap: item.isRead
                          ? null
                          : () async => service.markRead(item.id),
                    );
                  },
                ),
        ),
